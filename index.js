    ...
    return [
        {
            ...
            content:
                ...
                'Each ability must also include a short, natural activation cue in a separate abilityCue field. The cue must pair a concrete physical tell with focused visualization or intent, and it should feel unique or uncommon rather than like an everyday gesture. ' +
        ...
        },
        {
            ...
            content:
                ...
                'Option1Cue=short physical tell + visualization cue\n' +
                ...
                'Option2Cue=short physical tell + visualization cue\n' +
                ...
                'Option3Cue=short physical tell + visualization cue\n' +
    ...
    const prompt = [
...

        {
            ...
            content:
                ...
                '# ABILITIES: preserve explicit activated non-spell abilities only. If an explicit natural weapon has a special activated effect beyond ordinary bodily use, preserve that effect here. Include a separate abilityCue field with the activation cue if one is explicit. Preserve the cue as a concrete physical tell plus focused visualization or intent when present, and do not reduce it to a generic gesture. Prefer an unusual or distinctive physical tell over a routine motion. Do not preserve mundane expertise, combat techniques, hidden bonuses, passive traits, or broad skill competence as abilities. If none are explicit, write Not specified.\n' +
                '# SPELLS: preserve explicit spells only, maximum 5. If none are explicit, write None. Preserve healing spells, and include a separate spellCue field with the activation cue if one is explicit. Preserve the cue as a concrete physical tell plus focused visualization or intent when present, and do not reduce it to a generic gesture. Prefer an unusual or distinctive physical tell over a routine motion. Do not preserve resurrection, time/fate/luck manipulation, mind control/charm, broad magic mastery, or vague spell categories unless explicitly central canon.\n' +
