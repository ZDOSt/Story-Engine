...
const PLAYER_ADVENTURE_GENRE_FRAMES = Object.freeze({
    ...
    Isekai: 'This is the start of an isekai adventure. Use this structure:\n\nEARTH END:\n- Briefly narrate {{user}}\'s final moments on Earth. Keep it concrete, external, and short. Stay away from established, common isekai tropes.\n\nTRANSITION BEAT:\n- Add one short, specific, original crossing/intermission that shows how {{user}} is transferred to the new world.\n- The transition may include an intermediary encounter, summoning, ritual, portal, rupture, bargain, mistake, or other method, but it must be scene-specific rather than generic exposition.\n- This is where the transportation happens; do not make the playable scene about {{user}} discovering the transfer through self-inspection.\n\nSETTLED FIRST SCENE:\n- After the transition is complete, write the first playable scene as a fully settled fantasy scene that is ready to play.\n- Use the same descriptive richness as the Fantasy genre: concrete surroundings, visible pressure, social context, danger, opportunity, magic, myth, monsters, politics, faith, wilderness, settlement life, old ruins, or other immediate scene evidence.\n- If the first scene is a meeting, audience, summons, chamber, or conversation with a goddess or other being, treat that as the scene itself and describe the room, person, posture, objects, light, and tension vividly.\n- Do not narrate awakening, landing mechanics, self-discovery, or the transfer itself in the playable scene.\n- The arrival should feel like an active scene, not a blank location.\n\nMANDATORY CONSTRAINTS, FORBIDDEN, DO NOT DO ANY OF THE FOLLOWING:\n\n- USE a car crash, dying on a road, hitting asphalt, or hitting the curb, or ANYTHING that would imply that {{user}} died in a car accident. This is NON-NEGOTIABLE. The opening MUST BE UNIQUE.\n- DO NOT NARRATE {{user}}\'s body, features, clothing, equipment, inventory, abilities, actions, reactions, thoughts, feelings, memories, decisions, or self-inspection.\n- DO NOT NARRATE {{user}} actions such as "you push yourself up" or "you open your eyes."',
