...
export const GENERAL_PERSONALITY_PROFILES = Object.freeze([
    'temperament: guarded, suspicious, practical; speech: short direct questions with few pleasantries; interaction: tests claims and controls access before trusting; intensity:medium',
    'temperament: formal, procedural, dutiful; speech: precise rule-bound phrasing; interaction: follows rank, process, and documented authority; intensity:medium',
    'temperament: warm, direct, hospitable; speech: open invitations and plain reassurance; interaction: offers practical help while expecting honest answers; intensity:medium',
    'temperament: dry, observant, sardonic; speech: clipped understatement and quiet irony; interaction: watches before committing and points out practical flaws; intensity:medium',
    'temperament: nervous, appeasing, conflict-avoidant; speech: cautious qualifiers and quick concessions; interaction: seeks safety, permission, and reassurance before committing; intensity:medium',
    'temperament: proud, imperious, status-conscious; speech: polished commands and cool corrections; interaction: expects deference and protects reputation; intensity:medium',
    'temperament: playful, teasing, socially bold; speech: light provocation and quick banter; interaction: tests reactions through humor without committing too soon; intensity:medium',
    'temperament: cold, practical, unsentimental; speech: concise assessments and hard tradeoffs; interaction: values efficiency, leverage, and results; intensity:medium',
    'temperament: patient, scholarly, analytical; speech: careful distinctions and measured explanations; interaction: asks clarifying questions before acting; intensity:medium',
    'temperament: mercantile, opportunistic, personable; speech: friendly negotiation and price-aware framing; interaction: looks for advantage while preserving goodwill; intensity:medium',
    'temperament: devout, solemn, duty-led; speech: moral framing and restrained conviction; interaction: weighs actions against vows, signs, or obligations; intensity:medium',
    'temperament: blunt, physical, action-first; speech: plain statements and impatient challenges; interaction: trusts visible competence over explanation; intensity:medium',
    'temperament: cautious, observant, quietly protective; speech: low-risk suggestions and practical warnings; interaction: shields others without dramatics; intensity:medium',
    'temperament: curious, bright, easily engaged; speech: quick questions and eager connections; interaction: follows novelty and shares discoveries; intensity:medium',
    'temperament: bitter, weary, distrustful; speech: hard-earned warnings and skeptical replies; interaction: expects disappointment but respects proof; intensity:medium',
    'temperament: gentle, reserved, considerate; speech: careful wording and indirect concern; interaction: avoids pressure and helps through small acts; intensity:medium',
    'temperament: ambitious, polished, calculating; speech: controlled compliments and strategic questions; interaction: measures usefulness, status, and future leverage; intensity:medium',
    'temperament: reckless, bold, thrill-seeking; speech: confident dares and fast commitments; interaction: pushes momentum and underestimates risk; intensity:medium',
    'temperament: secretive, evasive, careful; speech: partial answers and controlled omissions; interaction: protects information and redirects scrutiny; intensity:medium',
    'temperament: nurturing, practical, firm; speech: plain care mixed with boundaries; interaction: helps concretely but refuses foolishness; intensity:medium',
]);

export function stripPersonalityMannerismFields(value) {
    return String(value ?? '')
        .split(';')
        ...
        .filter(field => {
            ...
            const label = field.slice(0, separator).trim().toLowerCase();
            return label !== 'mannerism' && label !== 'mannerisms';
        })
        .filter(Boolean)
        .join('; ')
        .replace(/\s+/g, ' ')
...
export const TRACKER_DELTA_CONTRACT = [
    ...
    '- NPC personalitySummary is stable personality memory only: a concise compact seed for enduring temperament, values, speech style, interaction style, or internal behavior pattern revealed by FINAL_NARRATION, SEMANTIC_PERSONALITY_EVIDENCE, or explicit first-contact personality seed.',
    ...
    '- Preferred format: "temperament: ...; speech: ...; interaction: ...; intensity:low|medium|high". Speech and interaction should carry most uniqueness.',
    '- When an active tracked NPC has no personalitySummary and durable first-contact evidence supports one, write a compact natural-language seed using the best matching internal pattern plus concrete traits, speech style, interaction style, and intensity.',
    ...
    '- Add SceneItemState.add when FINAL_NARRATION physically establishes a concrete inanimate object or material as present in the current scene, whether it is loose, placed, fixed, obstructed, locked, embedded, or otherwise difficult to manipulate. Exclude dialogue claims, hypotheticals, wishes, negated/absent items, latest-user-only assertions, body parts, natural weapons, and items currently carried or worn by an NPC. Scene presence does not imply reachability, successful access, ownership, or user possession.',
