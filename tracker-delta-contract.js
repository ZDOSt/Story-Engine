...
export const GENERAL_PERSONALITY_PROFILES = Object.freeze([
    'temperament: guarded, suspicious, practical; speech: short direct questions with few pleasantries; interaction: tests claims and controls access before trusting; mannerism: angles one shoulder toward the nearest exit when uncertain; intensity:medium',
    'temperament: formal, procedural, dutiful; speech: precise rule-bound phrasing; interaction: follows rank, process, and documented authority; mannerism: smooths a cuff before citing rules or names; intensity:medium',
    'temperament: warm, direct, hospitable; speech: open invitations and plain reassurance; interaction: offers practical help while expecting honest answers; mannerism: opens both hands when trying to reassure someone; intensity:medium',
    'temperament: dry, observant, sardonic; speech: clipped understatement and quiet irony; interaction: watches before committing and points out practical flaws; mannerism: lifts one brow before delivering a dry reply; intensity:medium',
    'temperament: nervous, appeasing, conflict-avoidant; speech: cautious qualifiers and quick concessions; interaction: seeks safety, permission, and reassurance before committing; mannerism: wrings their fingers when cornered; intensity:medium',
    'temperament: proud, imperious, status-conscious; speech: polished commands and cool corrections; interaction: expects deference and protects reputation; mannerism: lifts their chin before correcting someone; intensity:medium',
    'temperament: playful, teasing, socially bold; speech: light provocation and quick banter; interaction: tests reactions through humor without committing too soon; mannerism: rocks lightly on their heels while teasing; intensity:medium',
    'temperament: cold, practical, unsentimental; speech: concise assessments and hard tradeoffs; interaction: values efficiency, leverage, and results; mannerism: stills their hands before making a hard point; intensity:medium',
    'temperament: patient, scholarly, analytical; speech: careful distinctions and measured explanations; interaction: asks clarifying questions before acting; mannerism: taps a finger against their chin while sorting details; intensity:medium',
    'temperament: mercantile, opportunistic, personable; speech: friendly negotiation and price-aware framing; interaction: looks for advantage while preserving goodwill; mannerism: rubs thumb against forefinger when weighing terms; intensity:medium',
    'temperament: devout, solemn, duty-led; speech: moral framing and restrained conviction; interaction: weighs actions against vows, signs, or obligations; mannerism: presses two fingers together before judgment; intensity:medium',
    'temperament: blunt, physical, action-first; speech: plain statements and impatient challenges; interaction: trusts visible competence over explanation; mannerism: sets their feet square before challenging someone; intensity:medium',
    'temperament: cautious, observant, quietly protective; speech: low-risk suggestions and practical warnings; interaction: shields others without dramatics; mannerism: shifts their stance between people and nearby hazards; intensity:medium',
    'temperament: curious, bright, easily engaged; speech: quick questions and eager connections; interaction: follows novelty and shares discoveries; mannerism: leans in when a detail catches their interest; intensity:medium',
    'temperament: bitter, weary, distrustful; speech: hard-earned warnings and skeptical replies; interaction: expects disappointment but respects proof; mannerism: rubs the bridge of their nose before warning others; intensity:medium',
    'temperament: gentle, reserved, considerate; speech: careful wording and indirect concern; interaction: avoids pressure and helps through small acts; mannerism: folds their hands before refusing pressure; intensity:medium',
    'temperament: ambitious, polished, calculating; speech: controlled compliments and strategic questions; interaction: measures usefulness, status, and future leverage; mannerism: straightens their posture before negotiating; intensity:medium',
    'temperament: reckless, bold, thrill-seeking; speech: confident dares and fast commitments; interaction: pushes momentum and underestimates risk; mannerism: leans forward when danger appears; intensity:medium',
    'temperament: secretive, evasive, careful; speech: partial answers and controlled omissions; interaction: protects information and redirects scrutiny; mannerism: checks the room before answering sensitive questions; intensity:medium',
    'temperament: nurturing, practical, firm; speech: plain care mixed with boundaries; interaction: helps concretely but refuses foolishness; mannerism: sets hands on hips before drawing a boundary; intensity:medium',
]);
...
export const TRACKER_DELTA_CONTRACT = [
    ...
    '- NPC personalitySummary is stable personality memory only: a concise compact seed for enduring temperament, values, speech style, interaction style, one optional flexible visible physical mannerism, or internal behavior pattern revealed by FINAL_NARRATION, SEMANTIC_PERSONALITY_EVIDENCE, or explicit first-contact personality seed.',
    ...
    '- Preferred format: "temperament: ...; speech: ...; interaction: ...; mannerism: ...; intensity:low|medium|high". Speech and interaction should carry most uniqueness. A mannerism is a specific observable physical tell or habit, such as fidgeting with a sleeve, angling toward exits, tapping a finger while thinking, or touching a charm before speaking. It is not attitude, etiquette, strategy, kindness, politeness, holding a door, asking questions, offering help, making decisions, or any other generic social behavior. Mannerism is optional, flexible, scene-valid, and never a mandatory repeated beat.',
