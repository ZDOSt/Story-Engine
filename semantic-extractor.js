...
const COMPACT_LEDGER_CONTRACT = [
    ...
    '- TrackerUpdateEngine NPC personalitySummary is optional stable personality memory. If this is the first meaningful tracking of an NPC or the existing personalitySummary is empty, assign a compact personality seed when card/lore/scenario/context or visible behavior supports one. You may use one whitelisted archetype followed by concrete traits and intensity, e.g. tsundere; proud, guarded, sharp-tongued; hides concern through criticism; intensity:medium. Whitelisted archetypes: deredere, tsundere, yandere, kuudere, dandere, himedere, oujidere, kamidere, mayadere, sadodere, hiyakasudere, hajidere, bakadere, erodere, dorodere, shundere, undere, goudere, kanedere, byoukidere, none/custom. If personalitySummary already exists, use unchanged unless durable context clearly contradicts or refines it. Do not write mood, temporary emotion, injuries, relationship state, attraction, fear/hostility level, or what happened this turn.',
