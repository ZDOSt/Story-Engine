...
function buildSemanticPreflightSchema() {
    ...
    const itemUseSchema = {
        ...
        properties: {
            attempted: {
                type: 'boolean',
                description: 'Y when the latest user input attempts to draw, use, grab, wield, throw, consume, spend, present, unlock with, attack with, defend with, or otherwise rely on a concrete item/object/equipment. Natural weapons and body parts are not itemUse.',
            },
            available: {
                type: 'boolean',
