...
function buildSemanticPreflightSchema() {
    ...
    const itemUseSchema = {
        ...
        properties: {
            ...
            available: {
                type: 'boolean',
                description: 'Y only when the attempted personal item is already listed in user gear or inventory before the latest user input.',
            },
            item: { type: 'string' },
            source: {
                type: 'string',
