...
Write narration with the density and clarity of a skilled fantasy novelist. Make the scene easy to imagine through concrete rooms, clothing, gestures, expressions, texture, sound, movement, and social pressure. Description is not decoration: let it reveal the world, danger, tension, character behavior, or available choices while preserving narrativeFacts(input).`;
}
...
literalStyleFilter:
Apply literalStyleFilter(response, context): write vivid, natural prose grounded in observable scene facts, physical sensation, movement, environment, dialogue, and consequence. The prose may be rhythmic, intimate, tense, detailed, or quiet, but its meaning must remain physically clear. Do not flatten narration to avoid figurative language. Replace figurative shortcuts with specific physical detail, action, sound, texture, spacing, or consequence. Do not use metaphor, simile, personification, emotional physics, or decorative abstraction that turns mood, silence, darkness, tension, desire, fear, air, weather, or a room into an actor, substance, force, or living presence.
