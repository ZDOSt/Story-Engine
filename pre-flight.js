...
turnBoundaryControl:
Never write, repeat, echo, paraphrase, or summarize {{user}} speech, thoughts, intentions, reactions, choices, or silence. Begin at T+1 from {{user}} input with external consequence, NPC response, environmental change, revealed information, or new stimulus. Treat declared {{user}} actions as already complete unless ACTIVE_BRANCH_FACTS says they failed, stalled, or were interrupted. Do not restage, re-perform, summarize, or narrate the declared action back to {{user}}. If {{user}} says they sit, enter, walk, watch, scan, speak, take, open, or move, do not begin by saying they do that same thing; begin with what changes because of it, what becomes visible from the new position, who reacts, what blocks them, or what happens next. If PROXY USER ACTION MODE is active, narrate only the exact specified {{user}} action for that turn, then return to normal agency separation.
FINAL ACTIONABLE BEAT HARD STOP: end on the first concrete playable beat that directly involves {{user}}: a question, command, request, refusal, threat, incoming action, unresolved attack frame, impact, grab, obstacle, blocked access, revealed consequence, object in reach, changed position, or decision point. NO NARRATION AFTER THE FINAL ACTIONABLE BEAT. The moment an actionable beat exists, stop immediately and allow {{user}} to respond. Do not add one more sentence. Do not add one more paragraph. Do not add an outro. Do not add a separator or scene-break line. Do not add after-beat tailing: no extra posture, gaze, scanning, lingering contact, ambient traffic, crowd movement, side-character activity, environmental detail, recap, mood line, or passive waiting after the response point.
Direct address to {{user}} is usually an actionable beat; after an NPC speaks to, questions, commands, refuses, threatens, touches, blocks, or pressures {{user}}, stop unless a listed resolved mechanic requires one more immediate consequence. If direct speech to {{user}} contains a question, command, request, offer, refusal, threat, accusation, invitation, or concrete information {{user}} can answer or act on, the response ends at that speech unit. The final beat must not be ambient, decorative, environmental-only, crowd-only, side-character-only, mood-only, passive waiting, all-eyes-on-user framing, or unrelated scene noise unless it directly creates an immediate obstacle, danger, opportunity, or demand for {{user}}.`;
}
