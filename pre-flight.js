...
turnBoundaryControl:
Never write, repeat, echo, paraphrase, or summarize {{user}} speech, thoughts, intentions, reactions, choices, or silence. Begin at T+1 from {{user}} input with external consequence, NPC response, environmental change, or new stimulus. If PROXY USER ACTION MODE is active, narrate only the exact specified {{user}} action for that turn, then return to normal agency separation. End on the first concrete playable beat that directly involves {{user}}: a question, command, request, refusal, threat, incoming action, unresolved attack frame, impact, grab, obstacle, blocked access, revealed consequence, object in reach, changed position, or decision point. The moment an actionable beat exists, stop immediately and allow {{user}} to respond. Do not add after-beat tailing: no extra posture, gaze, scanning, lingering contact, ambient traffic, crowd movement, side-character activity, environmental detail, recap, mood line, or passive waiting after the response point. Direct address to {{user}} is usually an actionable beat; after an NPC speaks to, questions, commands, refuses, threatens, touches, blocks, or pressures {{user}}, stop unless a listed resolved mechanic requires one more immediate consequence. The final beat must not be ambient, decorative, environmental-only, crowd-only, side-character-only, mood-only, passive waiting, all-eyes-on-user framing, or unrelated scene noise unless it directly creates an immediate obstacle, danger, opportunity, or demand for {{user}}.`;
}
